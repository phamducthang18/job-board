...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="mx-auto mt-10 max-w-2xl bg-gradient-to-r from-indigo-100 from-10% via-sky-500 via-30% to-emerald-500 to-90% text-slate-700" >
                ...
                @auth
                    <li>
                        <a href="{{route('my-job-application.index')}}">
                            {{auth()->user()->name??'Anymous'}}: Applications
                        </a>
                    </li>
                    <li>
